...
- [ ] A user can create a host instantly and see a public `/h/:slug`, join link,
  scannable QR, and typeable code.
- [ ] A user can join by link, QR route, or code and remain in multiple hosts.
- [ ] `/h/:slug` shows member count, most-picked champion, consensus, and a
  handle-only leaderboard.
- [ ] Host pages honor the existing language, RTL, and theme system.
