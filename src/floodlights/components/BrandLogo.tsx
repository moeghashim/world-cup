...
export function BrandLogo() {
  return (
    <svg className="logo-svg" viewBox="0 0 248 64" role="img" aria-label="WIN 2026" direction="ltr" xmlns="http://www.w3.org/2000/svg">
      ...
      <text className="wmk" x="78" y="42" fontSize="30" fill="currentColor" direction="ltr" unicodeBidi="isolate">
